...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse createOrder(OrderRequest request) {
        ...
        if ((customerName == null || customerName.isBlank()) && table != null) {
            customerName = "Khach " + table.getTableName();
        }
    ...
    public OrderResponse confirmPayment(Long orderId, ConfirmPaymentRequest request) {
        ...
        if (request.getPaymentMethod() == PaymentMethod.COD) {
            throw new RuntimeException("COD payment does not require online confirmation");
        }
        ...
        order.setPaymentReference(
                request.getProviderTransactionId() == null || request.getProviderTransactionId().isBlank()
                        ? generatePaymentReference(request.getPaymentMethod())
    ...
    private OrderResponse mapToResponse(Order order) {
        ...
        return new OrderResponse(
                ...
                order.getUser() != null ? order.getUser().getUsername() : order.getCustomerName(),
    ...
    private String generatePaymentReference(PaymentMethod paymentMethod) {
        ...
        return paymentMethod.name() + "-" + timestamp + "-" + random;
    }
}
