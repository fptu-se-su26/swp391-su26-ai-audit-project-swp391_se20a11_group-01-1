    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:block w-[45%] relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent flex flex-col justify-end p-10">
          <h2 className="text-white text-3xl font-extrabold mb-2">Cái Gì Cũng Không Có</h2>
          <p className="text-white/80 text-sm">Trải nghiệm nhậu đỉnh cao tại TP.HCM</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <input type="text" placeholder="Họ và tên"
                ...
                className="px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-[#e85d04] focus:bg-white col-span-2" />
            </div>
